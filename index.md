...
| ----------------------- | ---------------- | ---------------- |  
| December 1, 2017 | Today's Board Display  | Created [Board_display](https://github.com/TheKeme/SensorEffector/blob/master/DOCUMENTS/TODAYSBLOG.docx). 
Image of the Error Board ![Image of the error board](https://github.com/TheKeme/SensorEffector/blob/master/IMAGES/board.PNG). 
Image of The Errors  ![Image of the errors](https://github.com/TheKeme/SensorEffector/blob/master/IMAGES/errors.PNG). 
Image Of Correction To Errors ![Image of the fixed board](https://github.com/TheKeme/SensorEffector/blob/master/IMAGES/FINISHEDBOARD.PNG). Image of the Board With A Smile ![Image of the fixed board with a smile](https://github.com/TheKeme/SensorEffector/blob/master/IMAGES/BOARDFIXED.jpg). |
